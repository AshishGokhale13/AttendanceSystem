		...
		<div class="header">
			<div class="main-header">
				...
				<div class="header-user">
					<div class="nav user-menu nav-list">
						...
						<div class="me-auto d-flex align-items-center" id="header-search">
								...
								<div class="dropdown-menu dropdown-lg dropdown-menu-start">
									<div class="card mb-0 border-0 shadow-none">
										...
										<div class="card-body pb-1">		
											<div class="row">
												<div class="col-sm-12">							
													<a href="../comingSoon/ComingSoon.jsp" class="d-flex align-items-center justify-content-between p-2 crm-link mb-3">
														<span class="d-flex align-items-center me-3">
															<i class="ti ti-user-shield text-default me-2"></i>Staff
														</span>
														<i class="ti ti-arrow-right"></i>
													</a>							
													<a href="../comingSoon/ComingSoon.jsp" class="d-flex align-items-center justify-content-between p-2 crm-link mb-3">
														<span class="d-flex align-items-center me-3">
															<i class="ti ti-heart-handshake text-default me-2"></i>Teacher
														</span>
														<i class="ti ti-arrow-right"></i>
													</a>								
													<a href="../comingSoon/ComingSoon.jsp" class="d-flex align-items-center justify-content-between p-2 crm-link mb-3">
														<span class="d-flex align-items-center me-3">
															<i class="ti ti-timeline-event-text text-default me-2"></i>Student
														</span>
														<i class="ti ti-arrow-right"></i>
													</a>		
												</div>
							...
							<a href="../comingSoon/ComingSoon.jsp" class="btn btn-menubar">
						...
						<div class="d-flex align-items-center">
								...
								<div class="dropdown-menu dropdown-menu-end">
									<div class="card mb-0 border-0 shadow-none">
										...
										<div class="card-body">											
											...
											<a href="../comingSoon/ComingSoon.jsp" class="d-block py-2 pb-0">
							...
							<div class="me-1">
								<a href="../comingSoon/ComingSoon.jsp" class="btn btn-menubar position-relative">
							...
							<div class="me-1 notification_item">
								...
								<div class="dropdown-menu dropdown-menu-end notification-dropdown p-4">
									...
									<div class="noti-content">
										<div class="d-flex flex-column">
											<div class="border-bottom mb-3 pb-3">
												<a href="../comingSoon/ComingSoon.jsp">
													<div class="d-flex">
											...
											<div class="border-bottom mb-3 pb-3">
												<a href="../comingSoon/ComingSoon.jsp" class="pb-0">
													<div class="d-flex">
														<span class="avatar avatar-lg me-2 flex-shrink-0">
									...
									<div class="d-flex p-0">
										...
										<a href="../comingSoon/ComingSoon.jsp" class="btn btn-primary w-100">View All</a>
									</div>
								</div>
							</div>
										...
										<div class="card-header">
											<div class="d-flex align-items-center">
												...
												<div>
													...
													<p class="fs-12 fw-medium mb-0"><a href="https://smarthr.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="3542544747505b75504d54584559501b565a58">[email&#160;protected]</a></p>
												</div>
											</div>
										</div>
										<div class="card-body">
				...
				<div class="dropdown mobile-user-menu">
					...
					<div class="dropdown-menu dropdown-menu-end">
						<a class="dropdown-item" href="../comingSoon/ComingSoon.jsp">My Profile</a>
						<a class="dropdown-item" href="../comingSoon/ComingSoon.jsp">Settings</a>
						<a class="dropdown-item" href="../comingSoon/ComingSoon.jsp">Logout</a>
					</div>
				</div>
				<!-- /Mobile Menu -->
